...
replace had_policy=1 if state=="26" & (cohort>=1993 & cohort<=1996) & engl==1
replace had_policy=1 if state=="28" & (cohort>=1990 & cohort<=1996) & engl==1
drop if state=="01" & (cohort>=1990 & cohort<=1995) & engl==0
drop if state=="05" & (cohort>=1988 & cohort<=1996) & engl==0
drop if state=="10" & (cohort>=1991 & cohort<=1996) & engl==0
drop if state=="19" & (cohort>=1987 & cohort<=1996) & engl==0
drop if state=="25" & (cohort>=1993 & cohort<=1996) & engl==0
drop if state=="26" & (cohort>=1993 & cohort<=1996) & engl==0
drop if state=="28" & (cohort>=1990 & cohort<=1996) & engl==0
keep if cohort>=1975 & cohort<=1996
